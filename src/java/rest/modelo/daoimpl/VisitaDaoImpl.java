...
public class VisitaDaoImpl implements VisitaDao {
    ...
    public boolean registrarVisita(Visita visita) {
        ...
        String COMANDO = "INSERT INTO visita VALUES (" + visita.getPersonaid() + ", '" + visita.getFechaentrada() + "', '" + visita.getHoraentrada() + "', '" + visita.getDestino() + "', '" + visita.getVisitado() + "', '" + visita.getDescripcion() + "', '" + visita.getHorasalida() + "', '" + visita.getFechasalida() + "', " + visita.getUsuarioid() + ", 1)";
        try {
            cx.execC(COMANDO);
            cx.Commit();
            cx.Close(1, 1, 1);
