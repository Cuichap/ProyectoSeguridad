            ...
            <div id="agregarTipoSalida" class="col-md-10 col-xs-offset-1" style="padding: 0px; display: none;">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form id="addtiposalida" class="form-signin" role="form" method="post" action="">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="tipoSalida">Tipo de Salida</label>
                                        <input type="text" class="form-control" id="tipoSalida" placeholder="Nombre del Tipo de Salida" name="tipoSalida">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
